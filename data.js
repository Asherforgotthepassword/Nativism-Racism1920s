// This file contains all the text and image settings for the website.
// ==========================================
// HOW TO EDIT:
// 1. Change the text inside the quotes "".
// 2. Save this file.
// 3. Refresh your browser (index.html).
// ==========================================

const siteContent = {
    hero: {
        title: "NATIVISM & RACISM",
        subtitle: "IN THE 1920s",
        description: "",
    ...
    migrationSection: {
        image: "assets/migration-map.jpg",
        caption: "Patterns of the Great Migration. African Americans migrating deep South to North and West states, 1900s - 1930."
    },
    vocabulary: [
        {
            term: "Nativism",
        ...
        {
            term: "Xenophobia",
            definition: "Fear or hatred of foreigners; fuels policies, movements, and laws."
        },
        {
            term: "Quota System",
        ...
        {
            term: "Deportation",
            definition: "The removal of immigrants from a country (U.S.), at times forcefully."
        },
        {
            term: "Misogyny",
    ...
    vocabImages: [
        ...
        },
        {
            ...
            title: "The New Majority Newspaper",
            caption: "Palmer Raids Front page of the Chicago Federation of Labor's newspaper, The New Majority, January 10, 1920, featuring an article that describes the Palmer Raids as terrorism."
        }
    ],
    timeline: [
        {
            ...
            description: "Banned Chinese laborers from immigrating to the U.S. Still in effect during the 1920s, and set the precedent for race-based immigration restrictions."
        },
        {
            year: "1906",
            title: "Naturalization Act of 1906",
            description: "Standardized citizenship rules and reinforced the idea that only certain immigrants could become “true” Americans, contributing to nativist attitudes."
        },
        {
            year: "1907",
            title: "Gentlemen’s Agreement",
            description: "An informal agreement between the United States and Japan that limited Japanese immigration without passing an official law, reflecting ideas of anti-Asian immigration."
        },
        {
            year: "1913–1920",
            title: "Alien Land Laws",
            description: "State laws that prevented Asian immigrants from owning land, especially in California, reinforcing racial discrimination and enforcing Nativist ideals."
        },
        {
            year: "1921",
            title: "Emergency Quota Act",
            description: "Limited immigration to 3% of each nationality already living in the U.S. based on the 1910 census, targeting Southern and Eastern Europeans. Connected to the deep fear of radical/communist takeover in the U.S."
        },
        {
            year: "1924",
            title: "Immigration Act of 1924 (Johnson–Reed Act)",
            description: "Reduced immigration quotas to 2% and used the population data provided by Congress (aka - 1890 census), favoring educated Northern and Western Europeans and banning most Asian immigration. Highlighted idea that uneducated immigrants harmed economy."
        }
    ],
    timelineImages: [
        {
            src: "assets/uploaded_media_0_1770106436150.png",
            title: "President Coolidge Signs Immigration Act",
            caption: "President Calvin Coolidge signs the Immigration Act on the White House South Lawn along with appropriation bills for the Veterans Bureau, Library of Congress."
        },
        {
            src: "assets/uploaded_media_1_1770106436150.jpg",
            title: "The Only One Barred Out",
            caption: "Enlightened American statesman – “We must draw the line somewhere, you know.” United States, 1882. [New York: Frank Leslie] Photograph. Library of Congress Prints and Photographs Division."
        },
        {
            src: "assets/uploaded_media_2_1770106436150.jpg",
            title: "Japanese Exclusion League Flier",
            caption: "A flier made by the Japanese Exclusion League of California urging white residents to vote in favor of the amended 1920 Alien Land Law. (National Museum of American History)."
        }
    ],
    legislation_meta: {
        backgroundImage: "assets/uploaded_media_0_1770106436150.png"
    },
    keyGroupsMeta: {
        backgroundImage: "assets/uploaded_media_1770106712265.png"
    },
    keyGroups: [
        {
    ...
    keyGroupsImages: [
        {
            src: "assets/uploaded_media_1770106712265.png",
            title: "Tennessee Cross Burning",
            caption: "The Ku Klux Klan burning a cross in Tennessee, 1948."
        }
    ],
    keyPeople: [
        {
        ...
        },
        {
            name: "Marcus Garvey",
            role: "Leader",
            description: "Black nationalist leader founded Universal Negro Improvement Association (UNIA), a shipping company Black Star Line, and Negro World newspaper. He work unified people, and grew power in the black community."
        }
    ],
    keyPeopleImages: [
        {
    ...
    changeImages: [
        {
            src: "assets/uploaded_media_0_1770106999629.png",
            title: "1921 Emergency Quota Act Cartoon",
            caption: "Cartoon depicting the 1921 Emergency Quota Act, showing Uncle Sam funneling European immigrants into the U.S. at a 3% rate."
        },
        {
            src: "assets/uploaded_media_1_1770106999629.png",
            title: "Protest Against Jim Crow",
            caption: "Demonstrators protesting against segregation and Jim Crow laws, holding signs declaring 'The Presence of Segregation is The Absence of Democracy'."
        }
    ],
    changeAndContinuity: {
    ...
    impactImages: [
        {
            src: "assets/uploaded_media_0_1770107309953.png",
            title: "KKK Parade",
            caption: "Ku Klux Klan parade march in Washington D.C."
        },
        {
            src: "assets/uploaded_media_1_1770107309953.png",
            title: "Immigration Chart",
            caption: "Foreign-born population in the United States in 1920."
        }
    ],
    resolution: {
        title: "How Was It Resolved? / Why Is It Still Relevant?",
        text: "By the late 1920s, the Ku Klux Klan (KKK) lost much of its influence due to scandals, corruption, and declining public support, but many of the policies it supported remained in place. Strict immigration quotas continued for decades and were not fully ended until the Immigration and Nationality Act of 1965, which finally removed race-based restrictions. The legacy of 1920s nativism, racism, and xenophobia is still relevant today, as modern debates over immigration, border control, and national identity reflect similar fears and attitudes. This era helps explain why later civil rights movements were necessary to challenge discrimination and expand equality in the United States.",
        backgroundImage: "assets/page_10_img_0.png"
    }
};
